    ...
    <div class="">
      ...
      <section id="kalimat" class="kalimat">
        <div class="container">
          ...
          $total_rows_query = "SELECT COUNT(*) AS total FROM valid_kalimat WHERE id_user = '$id_user'";
          if ($search) {
            $total_rows_query .= " AND madura LIKE '%$search%' OR indonesia LIKE '%$search%' OR keterangan LIKE '%$search%'";
          }
          ...
          $query = "SELECT * FROM valid_kalimat WHERE id_user = '$id_user' ";
          if ($search) {
            $query .= "AND madura LIKE '%$search%' OR indonesia LIKE '%$search%' OR keterangan LIKE '%$search%'";
          }
          ...
          <div class="d-flex justify-content-between align-items-center mb-3">
            <a href="data_kamus.php#kalimat" class="btn btn-danger mr-2">Kembali</a>
