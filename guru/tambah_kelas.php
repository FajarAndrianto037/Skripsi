...
if (isset($_POST['tambah'])) {
  ...
  // Lakukan pendaftaran
  $query = "INSERT INTO `kelas` (id_user, kelas, sekolah, kode, set_nilai) VALUES ('$id_user', '$kelas', '$sekolah', '$kode', '$set_nilai')";
      ...
      <div class="container">
        ...
        <form method="POST" action="">
          <div class="mb-3">
            ...
            <input type="text" name="kelas" class="form-control" id="" required="" aria-describedby="emailHelp">
          </div>
          <div class="mb-3">
            <label for="exampleInputkode1" class="form-label">Sekolah</label>
            <input type="text" name="sekolah" class="form-control" id="" required="">
          </div>
