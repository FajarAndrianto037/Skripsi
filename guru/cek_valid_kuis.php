    ...
    <div class="">
      ...
      <section id="kata" class="kata">
        <div class="container">
          ...
          $total_rows_query = "SELECT COUNT(*) AS total FROM valid_kuis WHERE id_user = '$id_user'";
          if ($search) {
          ...
          $query = "SELECT * FROM valid_kuis WHERE id_user = '$id_user'";
          if ($search) {
            $query .= " AND madura LIKE '%$search%' OR indonesia LIKE '%$search%' OR keterangan LIKE '%$search%'";
          }
          $query .= " ORDER BY valid_kuis_id DESC LIMIT $offset, $limit";
