...
if (isset($_POST['tambah'])) {
    ...
    $skt_valid = $_POST['skt_valid'];
    $proses = 'proses validasi';

    // Menyusun query SQL untuk insert
    $query = "INSERT INTO `valid_skt`  VALUES ('','$id_user', '$skt_valid', '$proses')";
    ...
    if ($result) {
      ...
      document.location = 'data_kamus.php#sukukata';
    </script>";
    } else {
        echo "<script type='text/javascript'>
            ...
            <div class="container">
                ...
                <form method="POST" action="">
                    <div class="mb-3">
                        ...
                        <input type="text" id="skt_valid" name="skt_valid" class="form-control" id="" required="">
                    </div>
                    ...
                    <script>
                        function karakter_e() {
                            teks = document.getElementById("skt_valid").value
                            document.getElementById("skt_valid").value = teks + "è"
                            document.getElementById("skt_valid").focus()
                            return false
                        }

                        function karakter_a() {
                            teks = document.getElementById("skt_valid").value
                            document.getElementById("skt_valid").value = teks + "â"
                            document.getElementById("skt_valid").focus()
                            return false
                        }
                    </script>
