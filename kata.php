...
if ($result) {
    ...
    if ($row['kuis_skt'] < $_SESSION['set_nilai'] || $row['kuis_huruf'] < $_SESSION['set_nilai']) {
    ...
    <div id="right-panel" class="">
        ...
        <div id="page-wrapper">
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "SELECT `madura`,`indonesia`,`tingkatan` FROM `kamus` WHERE `madura` LIKE 'a%' ORDER BY RAND() LIMIT 5;");
                                                while ($h = mysqli_fetch_array($q)) {
                                                ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h['madura']; ?>")><?php echo $h['madura']; ?></button>
                                                        </td>
                                                        <td>
                                                            <?php
                                        ...
                                        <button type="button" class="btn btn-info btn-lg" onClick="window.location.reload()">Acak Kata</button>
                                    </div>
                                </section>
                            </div>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "SELECT `madura`,`indonesia`,`tingkatan` FROM `kamus` WHERE `madura` LIKE 'b%' ORDER BY RAND() LIMIT 5;");
                                                while ($h = mysqli_fetch_array($q)) {
                                                ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h['madura']; ?>")><?php echo $h['madura']; ?></button>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "SELECT `madura`,`indonesia`,`tingkatan` FROM `kamus` WHERE `madura` LIKE 'c%' ORDER BY RAND() LIMIT 5;");
                                                while ($h = mysqli_fetch_array($q)) {
                                                ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h['madura']; ?>")><?php echo $h['madura']; ?></button>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "SELECT `madura`,`indonesia`,`tingkatan` FROM `kamus` WHERE `madura` LIKE 'd%' ORDER BY RAND() LIMIT 5;");
                                                while ($h = mysqli_fetch_array($q)) {
                                                ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h['madura']; ?>")><?php echo $h['madura']; ?></button>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "SELECT `madura`,`indonesia`,`tingkatan` FROM `kamus` WHERE `madura` LIKE 'e%' ORDER BY RAND() LIMIT 5;");
                                                while ($h = mysqli_fetch_array($q)) {
                                                ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h['madura']; ?>")><?php echo $h['madura']; ?></button>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "SELECT `madura`,`indonesia`,`tingkatan` FROM `kamus` WHERE `madura` LIKE 'f%' ORDER BY RAND() LIMIT 5;");
                                                while ($h = mysqli_fetch_array($q)) {
                                                ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h['madura']; ?>")><?php echo $h['madura']; ?></button>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "SELECT `madura`,`indonesia`,`tingkatan` FROM `kamus` WHERE `madura` LIKE 'g%' ORDER BY RAND() LIMIT 5;");
                                                while ($h = mysqli_fetch_array($q)) {
                                                ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h['madura']; ?>")><?php echo $h['madura']; ?></button>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "SELECT `madura`,`indonesia`,`tingkatan` FROM `kamus` WHERE `madura` LIKE 'h%' ORDER BY RAND() LIMIT 5;");
                                                while ($h = mysqli_fetch_array($q)) {
                                                ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h['madura']; ?>")><?php echo $h['madura']; ?></button>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "SELECT `madura`,`indonesia`,`tingkatan` FROM `kamus` WHERE `madura` LIKE 'i%' ORDER BY RAND() LIMIT 5;");
                                                while ($h = mysqli_fetch_array($q)) {
                                                ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h['madura']; ?>")><?php echo $h['madura']; ?></button>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "select `madura`,`indonesia`,`tingkatan` from `kamus` where `madura` like 'j%' order by rand() limit 5;");
                                                while ($h = mysqli_fetch_array($q)) { ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h[0]; ?>")><?php echo $h[0]; ?></button>
                                                        </td>
                                                        <td>
                                                            <?php
                                                            $input_kata = proses_fsa($h['madura']);
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "SELECT `madura`,`indonesia`,`tingkatan` FROM `kamus` WHERE `madura` LIKE 'k%' ORDER BY RAND() LIMIT 5;");
                                                while ($h = mysqli_fetch_array($q)) {
                                                ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h['madura']; ?>")><?php echo $h['madura']; ?></button>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "SELECT `madura`,`indonesia`,`tingkatan` FROM `kamus` WHERE `madura` LIKE 'l%' ORDER BY RAND() LIMIT 5;");
                                                while ($h = mysqli_fetch_array($q)) {
                                                ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick="play('<?php echo $h['madura']; ?>')"><?php echo $h['madura']; ?></button>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "SELECT `madura`,`indonesia`,`tingkatan` FROM `kamus` WHERE `madura` LIKE 'm%' ORDER BY RAND() LIMIT 5;");
                                                while ($h = mysqli_fetch_array($q)) {
                                                ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick="play('<?php echo $h['madura']; ?>')"><?php echo $h['madura']; ?></button>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "select `madura`,`indonesia`,`tingkatan` from `kamus` where `madura` like 'n%' order by rand() limit 5;");
                                                while ($h = mysqli_fetch_array($q)) { ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h[0]; ?>")><?php echo $h[0]; ?></button>
                                                        </td>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "select `madura`,`indonesia`,`tingkatan` from `kamus` where `madura` like 'o%' order by rand() limit 5;");
                                                while ($h = mysqli_fetch_array($q)) { ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h[0]; ?>")><?php echo $h[0]; ?></button>
                                                        </td>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "select `madura`,`indonesia`,`tingkatan` from `kamus` where `madura` like 'p%' order by rand() limit 5;");
                                                while ($h = mysqli_fetch_array($q)) { ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h[0]; ?>")><?php echo $h[0]; ?></button>
                                                        </td>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "select `madura`,`indonesia`,`tingkatan` from `kamus` where `madura` like 'r%' order by rand() limit 5;");
                                                while ($h = mysqli_fetch_array($q)) { ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h[0]; ?>")><?php echo $h[0]; ?></button>
                                                        </td>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "select `madura`,`indonesia`,`tingkatan` from `kamus` where `madura` like 's%' order by rand() limit 5;");
                                                while ($h = mysqli_fetch_array($q)) { ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h[0]; ?>")><?php echo $h[0]; ?></button>
                                                        </td>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "select `madura`,`indonesia`,`tingkatan` from `kamus` where `madura` like 't%' order by rand() limit 5;");
                                                while ($h = mysqli_fetch_array($q)) { ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h[0]; ?>")><?php echo $h[0]; ?></button>
                                                        </td>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "select `madura`,`indonesia`,`tingkatan` from `kamus` where `madura` like 'u%' order by rand() limit 5;");
                                                while ($h = mysqli_fetch_array($q)) { ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h[0]; ?>")><?php echo $h[0]; ?></button>
                                                        </td>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "select `madura`,`indonesia`,`tingkatan` from `kamus` where `madura` like 'v%' order by rand() limit 5;");
                                                while ($h = mysqli_fetch_array($q)) { ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h[0]; ?>")><?php echo $h[0]; ?></button>
                                                        </td>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "select `madura`,`indonesia`,`tingkatan` from `kamus` where `madura` like 'w%' order by rand() limit 5;");
                                                while ($h = mysqli_fetch_array($q)) { ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h[0]; ?>")><?php echo $h[0]; ?></button>
                                                        </td>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "select `madura`,`indonesia`,`tingkatan` from `kamus` where `madura` like 'y%' order by rand() limit 5;");
                                                while ($h = mysqli_fetch_array($q)) { ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h[0]; ?>")><?php echo $h[0]; ?></button>
                                                        </td>
                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center">
                                            ...
                                            <tbody>
                                                <?php
                                                $q = mysqli_query($mysqli, "select `madura`,`indonesia`,`tingkatan` from `kamus` where `madura` like 'z%' order by rand() limit 5;");
                                                while ($h = mysqli_fetch_array($q)) { ?>
                                                    <tr>
                                                        <td><button type="button" class="btn btn-warning btn-lg" onClick=play("<?php echo $h[0]; ?>")><?php echo $h[0]; ?></button>
                                                        </td>
            ...
            <div align="center" class="col-lg-4">
                <a href="quiz/quiz-kata/halaman-kata.php" class="btn btn-lg btn-success" role="button">Kuis Kata</a>
            </div>
        </div>
    </div>
    <!-- /.content -->
