                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Kata Madura</h4>
                                    <br>
                                    <?php
                                    ...
                                    $total_rows_query = "SELECT COUNT(*) AS total FROM kamus";
                                    if ($search) {
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="?delete=<?php echo $data['id']; ?>" onclick="return confirm('apakah anda yakin untuk delete?')">
                                                                    <span class="badge badge-danger">Delete</span>
                                                                </a>
                                                                <a href="edit_kata.php?edit=<?php echo $data['id']; ?>" onclick="return confirm('apakah anda yakin untuk edit data?')">
                                ...
                                if (isset($_GET['delete'])) {
                                    ...
                                    $querydelete = mysqli_prepare($mysqli, "DELETE FROM kamus WHERE id = ?");
                                    ...
                                    if (mysqli_stmt_execute($querydelete)) {
                                        ...
                                        window.location.href = 'kata_madura.php';
                                    </script>";
                                    }
