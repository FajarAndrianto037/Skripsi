...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "UPDATE valid_kata SET status = ? WHERE id_kata= ?";
                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Validasi Kata </h4>
                                    <br>
                                    <?php
                                    ...
                                    $total_rows_query = "SELECT COUNT(*) AS total FROM valid_kata";
                                    if ($search) {
                                    ...
                                    $query1 = "SELECT * FROM valid_kata";
                                    if ($search) {
                                        $query1 .= " WHERE madura LIKE '%" . mysqli_real_escape_string($mysqli, $search) . "%'";
                                    }
                                    $query1 .= " ORDER BY id_kata ASC LIMIT $offset, $limit";
                                    ...
                                    <table class="table table-striped table-bordered display">
                                        ...
                                        <tbody>
                                            ...
                                            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                                                ...
                                                $query_update = "UPDATE `valid_skt` SET `status` = '$status' WHERE `id_kata` = '$id_kata'";
                                                ...
                                                if ($status == 'permintaan diterima') {
                                                    $query_valid = "SELECT * FROM `valid_kata` WHERE `id_kata` = '$id_kata'";
                                                    ...
                                                    if ($result_valid) {
                                                        ...
                                                        $query_insert = "INSERT INTO `kamus` VALUES ('','$madura', '$indonesia', '$keterangan', '$tingkatan')";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form method="POST" action="" style="display:inline;">
                                                            <input type="hidden" name="id_kata" value="<?php echo $data['id_kata']; ?>">
