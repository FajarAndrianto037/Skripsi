                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    if (isset($_POST['simpan'])) {
                                        ...
                                        $query_edit = mysqli_query($mysqli, "UPDATE `suku_kata` SET skt='$skt' WHERE id='$id'");
                                        if ($query_edit) {
                                    ?>
                                            <script type="text/javascript">
                                                alert('Data berhasil diedit');
                                                window.location = 'suku_kata.php'; // Redirect ke halaman index setelah berhasil diedit
                                            </script>
                                        <?php
                                        } else {
                                    ...
                                    if (isset($_GET['edit'])) {
                                        ...
                                        $query = mysqli_query($mysqli, "SELECT * FROM suku_kata WHERE id='$id'");
                                        $data = mysqli_fetch_assoc($query);
                                        ?>
                                        <form method="post">
                                            <div class="mb-3">
                                                <label for="exampleInputEmail1" class="form-label">Suku Kata</label>
                                                <input type="text" name="skt" class="form-control" value="<?php echo $data['skt'] ?>" id="exampleInputEmail1" aria-describedby="emailHelp">
                                            </div>
