...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "UPDATE valid_skt SET status = ? WHERE id_skt = ?";
                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Validasi Suku Kata </h4>
                                    <br>
                                    <?php
                                    ...
                                    $total_rows_query = "SELECT COUNT(*) AS total FROM valid_skt";
                                    if ($search) {
                                    ...
                                    $query1 = "SELECT * FROM valid_skt";
                                    if ($search) {
                                        $query1 .= " WHERE madura LIKE '%" . mysqli_real_escape_string($mysqli, $search) . "%'";
                                    }
                                    $query1 .= " ORDER BY id_skt ASC LIMIT $offset, $limit";
                                    ...
                                    <table class="table table-striped table-bordered display">
                                        ...
                                        <tbody>
                                            ...
                                            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                                                ...
                                                $query_update = "UPDATE `valid_skt` SET `status` = '$status' WHERE `id_skt` = '$id_skt'";
                                                ...
                                                if ($status == 'permintaan diterima') {
                                                    $query_valid = "SELECT * FROM `valid_skt` WHERE `id_skt` = '$id_skt'";
                                                    $result_valid = mysqli_query($mysqli, $query_valid);
                                                    if ($result_valid) {
                                                        $data_valid = mysqli_fetch_assoc($result_valid);
                                                        $skt = $data_valid['skt_valid'];

                                                        $query_insert = "INSERT INTO `suku_kata` (`skt`) VALUES ('$skt')";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form method="POST" action="" style="display:inline;">
                                                            <input type="hidden" name="id_skt" value="<?php echo $data['id_skt']; ?>">
