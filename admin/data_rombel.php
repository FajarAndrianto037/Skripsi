                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    $total_rows_query = "SELECT COUNT(*) AS total FROM kelas";
                                    if ($search) {
                                        $total_rows_query .= " kelas LIKE '%$search%'";
                                    }
                                    ...
                                    if ($search) {
                                        $query .= " kelas LIKE '%$search%'";
                                    }
                                    $query .= " ORDER BY kelas_id DESC LIMIT $offset, $limit";
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="?delete=<?php echo $data['kelas_id']; ?>" onclick="return confirm('apakah anda yakin untuk delete?')">
                                                                    <span class="badge badge-danger">Delete</span>
                                                                </a>
                                                                <a href="edit_user.php?edit=<?php echo $data['kelas_id']; ?>" onclick="return confirm('apakah anda yakin untuk edit data?')">
