...
if (isset($_POST['tambah'])) {
    $madura = mysqli_real_escape_string($mysqli,  $_POST['madura']);
    $indonesia = mysqli_real_escape_string($mysqli,  $_POST['indonesia']);
    $keterangan = mysqli_real_escape_string($mysqli, $_POST['keterangan']);
    $tingkatan = mysqli_real_escape_string($mysqli, $_POST['tingkatan']);

    // Cek apakah data sudah ada
    $check_query = "SELECT * FROM `kamus` WHERE `madura` = '$madura' AND `indonesia` = '$indonesia'";
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        alert('Gagal Ditambah, Data sudah ada di database.');
        document.location = 'tambah_kalimat.php';
        </script>";
    } else {
        // Menyusun query SQL untuk insert
        $query = "INSERT INTO `kalimat` VALUES ('', '$madura', '$indonesia', '$keterangan', '$tingkatan')";
        ...
        if ($result) {
            ...
            document.location = 'kalimat_madura.php'; 
            </script>";
        } else {
            echo "<script type='text/javascript'>
                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Tambah Kalimat </h4>
                                    <br>
                                    <form method="POST" action="">
                                        <div class="mb-3">
                                            <label for="exampleInputkode1" class="form-label">Madura</label>
                                            <input type="text" id="madura" name="madura" class="form-control" required="">
                                        </div>
