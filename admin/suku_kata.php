                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Suku Kata</h4>
                                    <br>
                                    <?php
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <a href="tambah_suku_kata.php" class="btn btn-success mr-2">Tambah</a>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo htmlspecialchars($data['skt']); ?></td>
                                                            <td>
                                                                <a href="?delete=<?php echo $data['id']; ?>" onclick="return confirm('apakah anda yakin untuk delete?')">
                                                                    <span class="badge badge-danger">Delete</span>
                                                                </a>
                                                                <a href="edit_suku_kata.php?edit=<?php echo $data['id']; ?>" onclick="return confirm('apakah anda yakin untuk edit data?')">
                                ...
                                if (isset($_GET['delete'])) {
                                    ...
                                    $querydelete = mysqli_prepare($mysqli, "DELETE FROM suku_kata WHERE id = ?");
                                    ...
                                    if (mysqli_stmt_execute($querydelete)) {
                                        ...
                                        window.location.href = 'suku_kata.php';
                                    </script>";
                                    }
