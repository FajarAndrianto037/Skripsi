                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Kamus Madura </h4>
                                </div>
                                <div class="">
                                    <div class="">
                                        <table id="example" class="table table-striped table-bordered display">
                                            ...
                                            include "../koneksi.php";
                                            $nomor = 1;
                                            $query =  mysqli_query($mysqli,"SELECT * FROM suku_kata");
                                            while ($data = mysqli_fetch_assoc($query)) {
                                            ?>
                                            <?php if (isset($_GET['delete'])) {
                                            $id  = $_GET['delete'];
                                            $querydelete = mysqli_query($mysqli, "DELETE FROM suku_kata WHERE id='$id'");
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><span class="badge badge-warning">suara</span></td>
                                                    <td>
                                                    <a href="audio_madura.php?delete=<?php echo $data['id']; ?>" onclick="return confirm('apakah anda yakin untuk delete  ?')">
                                                    <span class="badge badge-danger">Delete</span>
                                                    </a>
                                                    <a href="edit_audio_madura.php?edit=<?php echo $data['id']; ?>" onclick="return confirm('apakah anda yakin untuk edit data  ?')">
