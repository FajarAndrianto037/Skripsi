                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    $total_rows_query = "SELECT COUNT(*) AS total FROM user WHERE level = 'guru'";
                                    if ($search) {
                                        $total_rows_query .= " AND (nama LIKE '%$search%' OR username LIKE '%$search%' OR level LIKE '%$search%')";
                                    }
                                    ...
                                    $query = "SELECT * FROM user WHERE level = 'guru'";
                                    if ($search) {
                                        $query .= " AND (nama LIKE '%$search%' OR username LIKE '%$search%' OR level LIKE '%$search%') ";
                                    }
                                    $query .= " ORDER BY id_user DESC LIMIT $offset, $limit";
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="?delete=<?php echo $data['id_user']; ?>" onclick="return confirm('apakah anda yakin untuk delete?')">
                                ...
                                if (isset($_GET['delete'])) {
                                    ...
                                    $querydelete = mysqli_prepare($mysqli, "DELETE FROM user WHERE id_user = ?");
