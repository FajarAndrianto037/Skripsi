                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Kelas Siswa </h4>
                                </div>
                                <div class="">
                                    <div class="">
                                        <table id="example" class="table table-striped table-bordered display">
                                            ...
                                            <tbody>
                                                ...
                                                include "../koneksi.php";
                                                $nomor = 1;
                                                $query =  mysqli_query($mysqli, "SELECT * FROM kamus");
                                                while ($data = mysqli_fetch_assoc($query)) {
                                                ?>
                                                    <?php if (isset($_GET['delete'])) {
                                                        $id  = $_GET['delete'];
                                                        $querydelete = mysqli_query($mysqli, "DELETE FROM kamus WHERE id='$id'");
                                                ...
                                                document.location='index.php';
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="kata_madura.php?delete=<?php echo $data['id']; ?>" onclick="return confirm('apakah anda yakin untuk delete  ?')">
                                                                <span class="badge badge-danger">Delete</span>
                                                            </a>
                                                            <a href="edit_kata_madura.php?edit=<?php echo $data['id']; ?>" onclick="return confirm('apakah anda yakin untuk edit data  ?')">
