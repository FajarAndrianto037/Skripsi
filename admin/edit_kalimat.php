                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    if (isset($_POST['simpan'])) {
                                        ...
                                        $query_edit = mysqli_query($mysqli, "UPDATE `kalimat` SET madura='$madura', indonesia='$indonesia', keterangan='$keterangan', tingkatan='$tingkatan' WHERE kalimat_id='$id'");
                                        if ($query_edit) {
                                    ?>
                                            <script type="text/javascript">
                                                alert('Data berhasil diedit');
                                                window.location = 'kalimat_madura.php'; // Redirect ke halaman index setelah berhasil diedit
                                            </script>
                                        <?php
                                        } else {
                                    ...
                                    if (isset($_GET['edit'])) {
                                        ...
                                        $query = mysqli_query($mysqli, "SELECT * FROM kalimat WHERE kalimat_id='$id'");
                                        $data = mysqli_fetch_assoc($query);
                                        ?>
                                        <form method="post">
                                            <div class="mb-3">
                                                <label for="exampleInputEmail1" class="form-label">Madura</label>
                                                <input type="text" name="madura" class="form-control" value="<?php echo $data['madura'] ?>" id="exampleInputEmail1" aria-describedby="emailHelp">
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleInputPassword1" class="form-label">Indonesia</label>
                                                <input type="text" name="indonesia" class="form-control" value="<?php echo $data['indonesia'] ?>" id="exampleInputPassword1">
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleInputPassword1" class="form-label">Keterangan</label>
                                                <input type="text" name="keterangan" class="form-control" value="<?php echo $data['keterangan'] ?>" id="exampleInputPassword1">
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleInputPassword1" class="form-label">Level</label>
                                                <select name="tingkatan" class="form-control" id="">
                                                    <option value=""><?php echo $data['tingkatan'] ?></option>
                                                    <option value="enjâ iyâ">enjâ iyâ</option>
                                                    <option value="engghi enten">engghi enten</option>
                                                    <option value="engghi bhunten">engghi bhunten</option>
                                                </select>
                                            </div>
