                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Kalimat Madura</h4>
                                    <br>
                                    <?php
                                    ...
                                    $total_rows_query = "SELECT COUNT(*) AS total FROM kalimat";
                                    if ($search) {
                                        $total_rows_query .= " WHERE madura LIKE '%$search%' OR indonesia LIKE '%$search%' OR keterangan LIKE '%$search%'";
                                    }
                                    ...
                                    if ($search) {
                                        $query .= " WHERE madura LIKE '%$search%' OR indonesia LIKE '%$search%' OR keterangan LIKE '%$search%'";
                                    }
                                    $query .= " ORDER BY kalimat_id DESC LIMIT $offset, $limit";
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo htmlspecialchars($data['madura']); ?></td>
                                                            <td><?php echo htmlspecialchars($data['indonesia']); ?></td>
                                                            <td><?php echo htmlspecialchars($data['tingkatan']); ?></td>
                                                            <td>
                                                                <a href="?delete=<?php echo $data['kalimat_id']; ?>" onclick="return confirm('apakah anda yakin untuk delete?')">
                                                                    <span class="badge badge-danger">Delete</span>
                                                                </a>
                                                                <a href="edit_kalimat.php?edit=<?php echo $data['kalimat_id']; ?>" onclick="return confirm('apakah anda yakin untuk edit data?')">
                                                                    <span class="badge badge-primary">Edit</span>
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                        $nomor--; // Decrement the number for the next row
                                                    }
                                                    ?>
                                                </tbody>
                                            </table>
                                ...
                                if (isset($_GET['delete'])) {
                                    ...
                                    $querydelete = mysqli_prepare($mysqli, "DELETE FROM kalimat WHERE kalimat_id = ?");
                                    ...
                                    if (mysqli_stmt_execute($querydelete)) {
                                        ...
                                        window.location.href = 'kalimat_madura.php';
                                    </script>";
                                    }
