                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Data Rombel</h4>
                                    <br>
...
JOIN user ON rombel_belajar.id_user = user.id_user";
                                    if ($search) {
                                        $total_rows_query .= " WHERE user.nama LIKE '%$search%' OR rombel_belajar.kuis_huruf LIKE '%$search%' OR rombel_belajar.kuis_skt LIKE '%$search%' OR rombel_belajar.kuis_kata LIKE '%$search%'";
                                    }
                                    ...
                                    $query = "SELECT rombel_belajar.*, user.nama
FROM rombel_belajar
JOIN user ON rombel_belajar.id_user = user.id_user";
                                    if ($search) {
                                        $query .= " WHERE user.nama LIKE '%$search%' OR rombel_belajar.kuis_huruf LIKE '%$search%' OR rombel_belajar.kuis_skt LIKE '%$search%' OR rombel_belajar.kuis_kata LIKE '%$search%'";
                                    }
                                    $query .= " ORDER BY rombel_belajar.rombel_id DESC LIMIT $offset, $limit";
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <a href="" class="btn btn-success">Daftar Nilai</a>

                                        <form class="form-inline my-2 my-lg-0" method="GET" action="#rombel">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo htmlspecialchars($data['kuis_huruf']); ?></td>
                                                            <td><?php echo htmlspecialchars($data['kuis_kata']); ?></td>
                                                            <td><?php echo htmlspecialchars($data['kuis_skt']); ?></td>
                                                            <td><?php echo htmlspecialchars($data['kuis_khusus']); ?></td>
                                                            <td><?php echo htmlspecialchars($data['kuis_bkata']); ?></td>
                                                            <td><?php echo htmlspecialchars($data['kuis_kalimat']); ?></td>
                                                            <td><?php echo htmlspecialchars($data['kuis_pemula1']); ?></td>
                                                            <td><?php echo htmlspecialchars($data['kuis_pemula2']); ?></td>
                                                            <td><?php echo htmlspecialchars($data['kuis_akhir']); ?></td>
                                                        </tr>
                                                    <?php
                                                        $nomor++; // Increment the number for the next row
                                                    }
                                                    ?>
                                                </tbody>
                                            </table>
                                ...
                                if (isset($_GET['delete'])) {
                                    ...
                                    $id = intval($_GET['delete']); // Convert to integer to prevent SQL injection

                                    // Prepare the deletion query
                                    $querydelete = mysqli_prepare($mysqli, "DELETE FROM kelas WHERE kelas_id = ?");
                                    ...
                                    if (mysqli_stmt_execute($querydelete)) {
                                        ...
                                        window.location.href = 'data_rombel.php';
                                    </script>";
                                    }
