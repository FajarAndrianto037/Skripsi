                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    if (isset($_POST['simpan'])) {
                                        ...
                                        $query_edit = mysqli_query($mysqli, "UPDATE `kamus` SET madura='$madura', indonesia='$indonesia', keterangan='$keterangan', tingkatan='$tingkatan' WHERE id='$id'");
                                        if ($query_edit) {
                                    ?>
                                            <script type="text/javascript">
                                                alert('Data berhasil diedit');
                                                window.location = 'kata_madura.php'; // Redirect ke halaman index setelah berhasil diedit
                                            </script>
                                        <?php
                                        } else {
                                    ...
                                    if (isset($_GET['edit'])) {
                                        ...
                                        $query = mysqli_query($mysqli, "SELECT * FROM kamus WHERE id='$id'");
