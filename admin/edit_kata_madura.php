                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Edit Kata</h4>
                                    <br>
                                    <?php
                                    ...
                                    if (isset($_POST['simpan'])) {
                                        ...
                                        $query_edit = mysqli_query($mysqli, "UPDATE `kamus` SET `madura` = '$madura', `indonesia` = '$indonesia', `keterangan` = '$keterangan', `tingkatan` = '$tingkatan' WHERE `kamus`.`id` = $id;");
                                        if ($query_edit) {
                                    ?>
                                            <script type="text/javascript">
                                                alert('Data berhasil diedit');
                                                window.location = 'index.php'; // Redirect ke halaman index setelah berhasil diedit
                                            </script>
                                        <?php
                                        } else {
                                    ...
                                    if (isset($_GET['edit'])) {
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="tingkatan" class="form-control" value="<?php echo $data['tingkatan'] ?>" id="exampleInputPassword1" required="">
                                            </div>
