...
if (isset($_POST['tambah'])) {
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        document.location = 'tambah_kata.php';
        </script>";
    } else {
        // Menyusun query SQL untuk insert
        $query = "INSERT INTO `kamus` VALUES ('', '$madura', '$indonesia', '$keterangan', '$tingkatan')";
        ...
        if ($result) {
            ...
            document.location = 'kata_madura.php'; 
            </script>";
        } else {
            echo "<script type='text/javascript'>
                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Tambah Kata </h4>
                                    <br>
