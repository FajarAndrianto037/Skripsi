...
if (isset($_POST['tambah'])) {
    ...
    if ($result) {
      ...
      alert('Data berhasail ditambahkan');
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="">
                                        <div class="mb-3">
                                            <label for="exampleInputkode1" class="form-label">nama</label>
                                            <input type="text" name="nama" class="form-control" id="" required="">
                                        </div>
                                        <div class="mb-3">
                                            <label for="exampleInputkode1" class="form-label">username</label>
                                            <input type="text" name="username" class="form-control" id="" required="">
                                        </div>
                                        <div class="mb-3">
                                            <label for="exampleInputkode1" class="form-label">password</label>
                                            <input type="text" name="password" class="form-control" id="" required="">
                                        </div>
                                        <div class="mb-3">
                                            <label for="exampleInputkode1" class="form-label">level</label>
                                            <select name="level" id="" class="form-control">
                                                <option value="">pilih</option>
                                                <option value="siswa">siswa</option>
                                                <option value="umum">siswa</option>
