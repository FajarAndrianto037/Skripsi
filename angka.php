    ...
    <div id="right-panel" class="">
        ...
        <div id="page-wrapper">
                ...
                <div style="height:430px;" class="col-lg-12">
                    <div class="presentation" style="    position: absolute;height: 100%;width: 100%;    left: 0px;    top: 0px;    display: block;    overflow: hidden;background: #ffffff; /* Mengatur warna latar belakang menjadi putih */">
                        ...
                        <div class="slides">
                            ...
                            $query = "SELECT `madura`, `indonesia` FROM `kamus` WHERE keterangan='angka' LIMIT $per_page OFFSET $offset";
                            $result = mysqli_query($mysqli, $query);
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination justify-content-center">
                                    ...
                                    $total_query = "SELECT COUNT(*) as total FROM `kamus` WHERE keterangan='angka'";
            ...
            <div align="center" class="col-lg-4">
                <a href="quiz/quiz-huruf/halaman-huruf.php" class="btn btn-lg btn-primary" role="button">Kuis Huruf & Angka</a>
            </div>
        </div>
    </div>
    <!-- /.content -->
