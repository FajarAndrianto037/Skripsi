    ...
    <div id="right-panel" class="">
        ...
        <div id="page-wrapper">
                ...
                <div style="height:430px;" class="col-lg-12">
                    <div class="presentation" style="    position: absolute;height: 100%;width: 100%;    left: 0px;    top: 0px;    display: block;    overflow: hidden;background: #ffffff; /* Mengatur warna latar belakang menjadi putih */">
                        ...
                        <div class="slides">
                            ...
                            $query = "SELECT `madura`, `indonesia` FROM `kamus` WHERE keterangan='anak-hewan' LIMIT $per_page OFFSET $offset";
                            $result = mysqli_query($mysqli, $query);

                            ?>
                            <br>
                            <div class="buttons-container">
                                <a href="nama-buah.php"><button type="button" class="btn btn-lg btn-danger">Nama Buah</button></a>
                                <a href="nama-tempat.php"><button type="button" class="btn btn-lg btn-danger">Nama Tempat</button></a>
                                <a href="anak-hewan.php"><button type="button" class="btn btn-lg btn-danger">Nama Hewan</button></a>
                            </div>
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination justify-content-center">
                                    ...
                                    $total_query = "SELECT COUNT(*) as total FROM `kamus` WHERE keterangan='anak-hewan'";
            ...
            <div align="center" class="col-lg-4">
                <a href="quiz/quiz-khusus/halaman-khusus.php" class="btn btn-lg btn-primary" role="button">Kuis Kata Khusus</a>
            </div>
        </div>
    </div>
    <!-- /.content -->
