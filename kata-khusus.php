    ...
    <div id="right-panel" class="">
        ...
        <header id="header" class="fixed-top d-flex align-items-center header">
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <div class="logo">
                    <h1><a href="halaman_belajar.php"><span>Belajar Kata Khusus</span></a></h1>
        ...
        <div id="page-wrapper">
            ...
            <div align="center" class="col-lg-4">
                <a href="quiz/quiz-khusus/halaman-khusus.php" class="btn btn-lg btn-primary" role="button">Kuis Kata</a>
            </div>
        </div>
    </div>
    <!-- /.content -->
