...
if (isset($_SESSION['rombel_id'])) {
	$query = "SELECT * FROM kuis_pembelajaran LIMIT 40";
				...
				<section id="features" class="features">
					<div class="container">
						<div class="section-title" data-aos="fade-up">
							...
							<p>Kuis Penilaian Akhir</p>
						</div>
						<main>
							<div class="container">
								<ul class="list-group">
									<li class="list-group-item"><strong>Jumlah kuis yang harus dikerjakan:</strong> 40</li>
									<li class="list-group-item"><strong>Jenis Kuis:</strong> Pilihan Ganda</li>
									<li class="list-group-item"><strong>Nilai Setiap Kuis:</strong> 2.5 Poin Untuk 1 Kuis</li>
								</ul>
								<a href="kuis-akhir.php?n=1" class="btn btn-primary mt-3">Mulai Kuis</a>
