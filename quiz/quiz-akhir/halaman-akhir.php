...
$query = "SELECT kuis_skt, kuis_huruf, kuis_kata, kuis_bkata, kuis_pemula1, kuis_khusus, kuis_kalimat, kuis_pemula2 FROM rombel_belajar WHERE id_user = '$id_user'";
...
if ($result) {
	...
	if ($row['kuis_skt'] < $_SESSION['set_nilai'] || $row['kuis_huruf'] < $_SESSION['set_nilai'] || $row['kuis_kata'] < $_SESSION['set_nilai'] || $row['kuis_bkata'] < $_SESSION['set_nilai'] || $row['kuis_pemula1'] < $_SESSION['set_nilai'] || $row['kuis_khusus'] < $_SESSION['set_nilai'] || $row['kuis_kalimat'] < $_SESSION['set_nilai'] || $row['kuis_pemula2'] < $_SESSION['set_nilai']) {
