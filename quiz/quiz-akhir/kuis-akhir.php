    ...
    <main id="main">
      ...
      if (isset($_SESSION['rombel_id'])) {
        ...
        if (isset($_GET['n']) && is_numeric($_GET['n'])) {
          ...
          header('location: kuis-akhir.php?n=' . $_SESSION['quiz']);
          exit; // Hentikan eksekusi skrip setelah redirect
        }
        // Kategori kuis yang akan dipilih secara acak
        $kategori_kuis = array('huruf-angka', 'suku-kata', 'kata', 'bendahara-kata', 'kata-khusus', 'kalimat');
        ...
        if (mysqli_num_rows($run) > 0) {
          ...
          // Menghitung jumlah total soal berdasarkan jenis 'akhir-angka'
          $total_akhir_angka = "SELECT * FROM kuis_pembelajaran WHERE jenis_kuis IN ($kategori_string)";
          $run_akhir_angka = mysqli_query($mysqli, $total_akhir_angka) or die(mysqli_error($mysqli));
          $total_akhir_angka_qn = mysqli_num_rows($run_akhir_angka);
        } else {
      ...
      <section class="page-section" id="contact">
        <div class="container d-flex justify-content-center align-items-center vh-50" id="quiz">
          <div class="question p-5  w-100">
            <p>Question <?php echo $qno; ?> of 40</p>
            <b>
              <h4 class="question w-100"><?php echo $qno, '. ', $question; ?></h4>
            </b>
            <br>
            <div class="mb-4">
              <form method="post" action="proses-akhir.php">
                <div class="question">
