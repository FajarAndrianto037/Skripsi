...
?>
	<?php if (!isset($_SESSION['kuis_pemula1'])) {
		header("location: kuis-pemula1.php?n=1");
	}
	?>
	<html lang="en">
...
======================================================== -->
	...
	<body>
				...
				<div class="container">
					<ul class="list-group">
						...
						<?php if (isset($_SESSION['kuis_pemula1'])) {
							...
							$total_point = $_SESSION['kuis_pemula1'];
					...
					<a href="kuis-pemula1.php?n=1" class="btn btn-primary mt-3">Coba Lagi Kuis</a>
					<a href="../../halaman_belajar.php" class="btn btn-danger mt-3 ml-2">Keluar</a>
					<a href="../../halaman-kata-khusus.php" class="btn btn-info mt-3 ml-2">Next Materi</a>
				</div>
			</main>
		...
		$kuis_pemula1 = $_SESSION['kuis_pemula1'];
		$id_user = $_SESSION['id_user'];
		$query = "SELECT kuis_pemula1 FROM rombel_belajar WHERE id_user = '$id_user'";
		$result = mysqli_query($mysqli, $query);
		if ($result) {
			$row = mysqli_fetch_assoc($result);
			$existing_kuis_pemula1 = $row['kuis_pemula1'];
			if ($kuis_pemula1 > $existing_kuis_pemula1) {
				$query = "UPDATE rombel_belajar SET kuis_pemula1 = '$kuis_pemula1' WHERE id_user = '$id_user'";
				$run = mysqli_query($mysqli, $query) or die(mysqli_error($mysqli));
			}
		}
		?>
		<?php unset($_SESSION['kuis_pemula1']); ?>
