...
if (isset($_SESSION['rombel_id'])) {
	$query = "SELECT * FROM kuis_pembelajaran LIMIT 20";
...
?>
  ...
  * License: https://bootstrapmade.com/license/
  ======================================================== -->
						...
						<main>
							<div class="container">
								<ul class="list-group">
									...
									<li class="list-group-item"><strong>Nilai Setiap Kuis:</strong> 5 Poin Untuk 1 Kuis</li>
								</ul>
								<a href="kuis-pemula1.php?n=1" class="btn btn-primary mt-3">Mulai Kuis</a>
	...
	<?php } else {
	header("location: halaman-pemula1.php");
}
	?>