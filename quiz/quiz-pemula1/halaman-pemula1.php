...
$query = "SELECT kuis_skt, kuis_huruf, kuis_kata, kuis_bkata FROM rombel_belajar WHERE id_user = '$id_user'";
...
if ($result) {
	...
	if ($row['kuis_skt'] < $_SESSION['set_nilai'] || $row['kuis_huruf'] < $_SESSION['set_nilai'] || $row['kuis_kata'] < $_SESSION['set_nilai'] || $row['kuis_bkata'] < $_SESSION['set_nilai']) {
