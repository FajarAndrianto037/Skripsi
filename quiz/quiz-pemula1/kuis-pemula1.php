    ...
    <main id="main">
      ...
      if (isset($_SESSION['rombel_id'])) {
        ...
        if (isset($_GET['n']) && is_numeric($_GET['n'])) {
          ...
          header('location: kuis-pemula1.php?n=' . $_SESSION['quiz']);
          exit; // Hentikan eksekusi skrip setelah redirect
        }
        // Kategori kuis yang akan dipilih secara acak
        $kategori_kuis = array('huruf-angka', 'suku-kata', 'kata', 'bendahara-kata');
        ...
        if (mysqli_num_rows($run) > 0) {
          ...
          // Menghitung jumlah total soal berdasarkan jenis 'pemula1-angka'
          $total_pemula1_angka = "SELECT * FROM kuis_pembelajaran WHERE jenis_kuis IN ($kategori_string)";
          $run_pemula1_angka = mysqli_query($mysqli, $total_pemula1_angka) or die(mysqli_error($mysqli));
          $total_pemula1_angka_qn = mysqli_num_rows($run_pemula1_angka);
        } else {
      ...
      <section class="page-section" id="contact">
        <div class="container d-flex justify-content-center align-items-center vh-50" id="quiz">
          <div class="question p-5  w-100">
            ...
            <br>
            <div class="mb-4">
              <form method="post" action="proses-pemula1.php">
                <div class="question">
