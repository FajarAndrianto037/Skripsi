  ...
  <body>
    ...
    <main id="main">
      ...
      if (isset($_SESSION['rombel_id'])) {
        ...
        if (isset($_GET['n']) && is_numeric($_GET['n'])) {
          ...
          header('location: kuis-skt.php?n=' . $_SESSION['quiz']);
        ...
        if (!empty($_SESSION['qid_list'])) {
          ...
          $query = "SELECT * FROM kuis_pembelajaran WHERE jenis_kuis = 'suku-kata' and qid NOT IN ($qid_list_str) ORDER BY RAND() LIMIT 1";
        } else {
          // Jika qid_list kosong, ambil soal acak
          $query = "SELECT * FROM kuis_pembelajaran WHERE jenis_kuis = 'suku-kata' ORDER BY RAND() LIMIT 1";
        }
        ...
        if (mysqli_num_rows($run) > 0) {
          ...
          // Menghitung jumlah total soal berdasarkan jenis 'skt-angka'
          $total_skt_angka = "SELECT * FROM kuis_pembelajaran WHERE jenis_kuis = 'suku-kata'";
          $run_skt_angka = mysqli_query($mysqli, $total_skt_angka) or die(mysqli_error($mysqli));
          $total_skt_angka_qn = mysqli_num_rows($run_skt_angka);
        } else {
      ...
      <section class="page-section" id="contact">
        <div class="container d-flex justify-content-center align-items-center vh-50" id="quiz">
          <div class="question p-5  w-100">
            ...
            <br>
            <div class="mb-4">
              <form method="post" action="proses-skt.php">
                <div class="question">
    ...
    <script>
      window.addEventListener('', function(e) {
        // Cek apakah terdapat parameter 'n' dalam URL
        var n = <?php echo isset($_GET['n']) ? intval($_GET['n']) : 0; ?>;
        // Jika n kurang dari 5, tampilkan pesan
        if (n < 5) {
          // Tampilkan pesan konfirmasi
          var confirmationMessage = 'Jika Anda keluar, jawaban akan hilang.';
          // Set pesan konfirmasi pada event
