...
?>
  ...
  * License: https://bootstrapmade.com/license/
  ======================================================== -->
						...
						<main>
							<div class="container">
								<ul class="list-group">
									...
									<li class="list-group-item"><strong>Nilai Setiap Soal:</strong> 10 Poin</li>
								</ul>
								<a href="kuis-huruf.php?n=1" class="btn btn-primary mt-3">Mulai Kuis</a>
								<a href="../../huruf-angka.php" class="btn btn-danger mt-3 ml-2">Keluar</a>
							</div>
						</main>
	...
	<?php } else {
	header("location: halaman-huruf.php");
}
	?>