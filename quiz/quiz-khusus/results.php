...
?>
	<?php if (!isset($_SESSION['kuis_khusus'])) {
		header("location: kuis-khusus.php?n=1");
	}
	?>
	<html lang="en">
...
======================================================== -->
	...
	<body>
				...
				<div class="container">
					<ul class="list-group">
						...
						<?php if (isset($_SESSION['kuis_khusus'])) {
							...
							$total_point = $_SESSION['kuis_khusus'];
					...
					<a href="kuis-khusus.php?n=1" class="btn btn-primary mt-3">Coba Lagi Kuis</a>
					<a href="../../halaman_belajar.php" class="btn btn-danger mt-3 ml-2">Keluar</a>
					<a href="../../halaman-kalimat.php" class="btn btn-info mt-3 ml-2">Next Materi</a>
				</div>
			</main>
		...
		$kuis_khusus = $_SESSION['kuis_khusus'];
		$id_user = $_SESSION['id_user'];
		$query = "SELECT kuis_khusus FROM rombel_belajar WHERE id_user = '$id_user'";
		$result = mysqli_query($mysqli, $query);
		if ($result) {
			$row = mysqli_fetch_assoc($result);
			$existing_kuis_khusus = $row['kuis_khusus'];
			if ($kuis_khusus > $existing_kuis_khusus) {
				$query = "UPDATE rombel_belajar SET kuis_khusus = '$kuis_khusus' WHERE id_user = '$id_user'";
