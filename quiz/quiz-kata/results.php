...
?>
	<?php if (!isset($_SESSION['kuis_kata'])) {
		header("location: kuis-kata.php?n=1");
	}
	?>
	<html lang="en">
...
======================================================== -->
	...
	<body>
				...
				<div class="container">
					<ul class="list-group">
						...
						<?php if (isset($_SESSION['kuis_kata'])) {
							...
							$total_point = $_SESSION['kuis_kata'];
					...
					<a href="kuis-kata.php?n=1" class="btn btn-primary mt-3">Coba Lagi Kuis</a>
					<a href="../../halaman_belajar.php" class="btn btn-danger mt-3 ml-2">Keluar</a>
					<a href="../../bendahara-kata.php" class="btn btn-info mt-3 ml-2">Next Materi</a>
				</div>
			</main>
		...
		$kuis_kata = $_SESSION['kuis_kata'];
		$id_user = $_SESSION['id_user'];
		$query = "SELECT kuis_kata FROM rombel_belajar WHERE id_user = '$id_user'";
		$result = mysqli_query($mysqli, $query);
		if ($result) {
			$row = mysqli_fetch_assoc($result);
			$existing_kuis_kata = $row['kuis_kata'];
			if ($kuis_kata > $existing_kuis_kata) {
				$query = "UPDATE rombel_belajar SET kuis_kata = '$kuis_kata' WHERE id_user = '$id_user'";
				$run = mysqli_query($mysqli, $query) or die(mysqli_error($mysqli));
			}
		}
		?>
		<?php unset($_SESSION['kuis_kata']); ?>
