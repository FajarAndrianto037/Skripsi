    ...
    <main id="main">
      ...
      if (isset($_SESSION['rombel_id'])) {
        ...
        if (isset($_GET['n']) && is_numeric($_GET['n'])) {
          ...
          header('location: kuis-kata.php?n=' . $_SESSION['quiz']);
        ...
        if (!empty($_SESSION['qid_list'])) {
          ...
          $query = "SELECT * FROM kuis_pembelajaran WHERE jenis_kuis = 'kata' and qid NOT IN ($qid_list_str) ORDER BY RAND() LIMIT 1";
        } else {
          // Jika qid_list kosong, ambil soal acak
          $query = "SELECT * FROM kuis_pembelajaran WHERE jenis_kuis = 'kata' ORDER BY RAND() LIMIT 1";
        }
        ...
        if (mysqli_num_rows($run) > 0) {
          ...
          // Menghitung jumlah total soal berdasarkan jenis 'kata-angka'
          $total_kata_angka = "SELECT * FROM kuis_pembelajaran WHERE jenis_kuis = 'kata'";
          $run_kata_angka = mysqli_query($mysqli, $total_kata_angka) or die(mysqli_error($mysqli));
          $total_kata_angka_qn = mysqli_num_rows($run_kata_angka);
        } else {
      ...
      <section class="page-section" id="contact">
        <div class="container d-flex justify-content-center align-items-center vh-50" id="quiz">
          <div class="question p-5  w-100">
            ...
            <br>
            <div class="mb-4">
              <form method="post" action="proses-kata.php">
                <div class="question">
