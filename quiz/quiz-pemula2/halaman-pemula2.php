...
$query = "SELECT kuis_skt, kuis_huruf, kuis_kata, kuis_bkata, kuis_pemula1, kuis_khusus, kuis_kalimat FROM rombel_belajar WHERE id_user = '$id_user'";
...
if ($result) {
	...
	if ($row['kuis_skt'] < $_SESSION['set_nilai'] || $row['kuis_huruf'] < $_SESSION['set_nilai'] || $row['kuis_kata'] < $_SESSION['set_nilai'] || $row['kuis_bkata'] < $_SESSION['set_nilai'] || $row['kuis_pemula1'] < $_SESSION['set_nilai'] || $row['kuis_khusus'] < $_SESSION['set_nilai'] || $row['kuis_kalimat'] < $_SESSION['set_nilai']) {
		...
		if (mysqli_num_rows($runcheck) > 0) {
			...
			if (mysqli_affected_rows($mysqli) > 0) {
				...
				if (mysqli_num_rows($run2) > 0) {
					$row_cek = mysqli_fetch_array($run2);
					$rombel_id = $row['rombel_id'];
					$_SESSION['rombel_id'] = $rombel_id;
					$_SESSION['id_user'] = $row_cek['id_user'];
					header("location: home.php");
				}
			} else {
