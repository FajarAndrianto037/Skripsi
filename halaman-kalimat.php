...
$query = "SELECT kuis_skt, kuis_huruf, kuis_kata, kuis_bkata, kuis_pemula1, kuis_khusus FROM rombel_belajar WHERE id_user = '$id_user'";
...
if ($result) {
    ...
    if ($row['kuis_skt'] < $_SESSION['set_nilai'] || $row['kuis_huruf'] < $_SESSION['set_nilai'] || $row['kuis_kata'] < $_SESSION['set_nilai'] || $row['kuis_bkata'] < $_SESSION['set_nilai'] || $row['kuis_pemula1'] < $_SESSION['set_nilai'] || $row['kuis_khusus'] < $_SESSION['set_nilai']) {
...
// Jika nilai kuis_skt dan kuis_huruf >= $_SESSION['set_nilai'], maka beri akses ke halaman suku-kata.php
        ...
        <div class="">
            ...
            <section id="features" class="features">
                <div class="container">
                    ...
                    <h3>Kalimat Madura</h3><br>
                    <div class="row" data-aos="fade-left">
                        <div class="col-lg-4 col-md-4 ">
                            <div class="icon-box" data-aos="zoom-in" data-aos-delay="50">
                                <i class="ri-calendar-todo-line" style="color: #ffbb2c;"></i>
                                <h3><a href="kalimat-iye.php">Kalimat Enje' Iyâ</a></h3>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 ">
                            <div class="icon-box" data-aos="zoom-in" data-aos-delay="100">
                                <i class="ri-calendar-todo-line" style="color: #5578ff;"></i>
                                <h3><a href="kalimat-enten.php">Kalimat Engghi Enten</a></h3>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 ">
                            <div class="icon-box" data-aos="zoom-in" data-aos-delay="150">
                                <i class="ri-calendar-todo-line" style="color: #e80368;"></i>
                                <h3><a href="kalimat-bhunten.php">Kalimat Engghi Bhunten</a></h3>
                            </div>
                        </div>
