        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-12" align="center">
                    <img src="image/Pyepit Rinekso.jpg" height="180px" width="130px">
                    <h4>Aplikasi ini dibuat oleh :</h4>
                    <h4><strong>PYEPIT RINEKSO ANDRIYANTO</strong></h4>
                    <h5>email : <em>pyepitrineksoa@gmail.com / pyepitrineksoa@live.com</em></h5>
                    <h5>website : <em>pyepitrineksoa.blogspot.com</em></h5>
                    <h4>Profil Penulis</h4>
                    <p>
                        Pyepit Rinekso Andriyanto, lahir di Sumenep, 25 Februari 1991.
                        Meskipun studi mayornya Teknik Informatika, ia amat menggemari ekonomi, sosial, dan bisnis.
                        <br>
                        Khancink Konveksi adalah salah satu usahanya selama kuliah.
                        Sekarang ia tengah mengejar mimpinya menjadi seorang pengusaha dan penulis.
                        <br>
                        Pyepit, nama yang sering dipanggil sehari-hari, berpendidikan Teknik Informatika di Universitas
                        Trunojoyo Madura.
                        <br>
                        Ia mendapat beasiswa Djarum Plus di tahun 2013-2014.
                        <br>
                        Al-Quran dan As-Sunnah selalu menjadi landasannya dalam menginspirasi aktivitasnya sehari-hari.
                        <br>
                        Lebih lengkapnya silahkan liat di twitter @pyepitrineksoa
                    </p>
